// frontend/src/app/user-dashboard/profile/page.js
'use client';
  ...
  return (
    <div>
      ...
      <header className="mb-8 border-b border-[var(--color-border)] pb-6">
        ...
        <p className="text-sm text-[var(--color-text-secondary)] mt-1">Manage your personal profile and notification preferences.</p>
      </header>
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="w-full lg:w-48 flex-shrink-0 flex flex-row lg:flex-col gap-2 overflow-x-auto pb-2 lg:pb-0">
          <button
            ...
            className={`text-left px-4 py-2 rounded text-xs transition-colors whitespace-nowrap ${
              activeTab === 'profile'
        ...
        <div className="flex-1">
          {activeTab === 'profile' && (
            <Card variant="standard" className="p-6">
              <h2 className="text-lg font-bold text-[var(--color-text-primary)] mb-6 border-b border-[var(--color-border)] pb-4">
                Public Profile
              </h2>
              <form onSubmit={handleProfileSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={4}
                    className="w-full bg-[var(--color-bg)] border border-[var(--color-border)] hover:border-[var(--color-text-secondary)] focus:border-[var(--color-primary)] rounded px-3 py-2 text-xs text-[var(--color-text-primary)] placeholder-[var(--color-text-secondary)]/60 outline-none transition-all duration-150 focus:ring-2 focus:ring-[var(--color-primary)]/20 resize-y"
              ...
              <div className="space-y-6">
                ...
                <div className="pt-2">
                  ...
                  <select 
                    ...
                    className="w-full sm:w-64 bg-[var(--color-bg)] border border-[var(--color-border)] hover:border-[var(--color-text-secondary)] focus:border-[var(--color-primary)] rounded px-3 py-2 text-xs text-[var(--color-text-primary)] outline-none"
                  >
